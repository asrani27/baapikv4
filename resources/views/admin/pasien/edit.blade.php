...
<section class="content">
  ...
  <div class="row">
    ...
    <!-- /.box-header -->
    <form class="form-horizontal" method="post" action="/superadmin/pasien/edit/{{$data->id}}">
        @csrf
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nik" placeholder="NIK" value="{{$data == null ? '': $data->nik}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="noRM" placeholder="no rekam medis" value="{{$data->noRM}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control" name="tglLahir" value="{{$data == null ? '': $data->tglLahir}}">
            </div>
        </div>
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="telp" placeholder="telp" value="{{$data == null ? '': $data->telp}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nama Ayah</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nama_ayah" placeholder="nama ayah" value="{{$data->nama_ayah}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Telp Ayah</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="telp_ayah" placeholder="telp ayah" value="{{$data->telp_ayah}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nama Ibu</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nama_ibu" placeholder="nama ibu" value="{{$data->nama_ibu}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Telp Ibu</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="telp_ibu" placeholder="telp_ibu" value="{{$data->telp_ibu}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nama Penanggung Jawab</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nama_penanggung_jawab" placeholder="nama penanggung jawab" value="{{$data->nama_penanggung_jawab}}">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Telp Penanggung Jawab</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="telp_penanggung_jawab" placeholder="telp penanggung jawab" value="{{$data->telp_penanggung_jawab}}">
            </div>
        </div>
        <div class="form-group">
