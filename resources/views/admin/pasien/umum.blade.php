...
<section class="content">
  ...
  <div class="row">
    ...
    <i class="fa fa-user-plus"></i>
      <h3 class="box-title">Pendaftaran Pasien Umum</h3>
    </div>
    <!-- /.box-header -->
    <form class="form-horizontal" method="post" action="/superadmin/pasien/daftar/umum/{{$id}}">
        @csrf
    <div class="box-body">
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">NIK</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nik" placeholder="NIK" value="{{$data->nik}}" readonly>
            </div>
        </div>
        <div class="form-group">
