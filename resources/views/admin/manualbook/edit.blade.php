...
<section class="content">
    <div class="row">
        ...
        <h3 class="box-title">Edit Manual Book</h3>
        </div>
        <!-- /.box-header -->
        <form class="form-horizontal" method="post" action="/superadmin/manualbook/edit/{{$id}}">
            @csrf
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="isi" id="editor_classic">{!!$data->isi!!}</textarea>
                </div>
            </div>
        </div>
