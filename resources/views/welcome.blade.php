...
<div class="wrapper">
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/bg5.jpeg'); background-size:cover">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <img src="/logo/pemko.png" width="25%"><br/><br/>
            </div>
            <div class="box box-primary" style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
              <div class="box-header with-border text-center">
                <h3 class="box-title">Baapik - Aplikasi Puskesmas</h3>
